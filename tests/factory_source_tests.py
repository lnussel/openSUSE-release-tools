...
class TestFactorySourceAccept(unittest.TestCase):
    ...
    def test_accept_request(self):
        ...
        httpretty.register_uri(httpretty.GET,
            APIURL + "/source/Base:System/timezone?rev=481ecbe0dfc63ece3a1f1b5598f7d96c&view=info",
            body = """
        ...
        httpretty.register_uri(httpretty.GET,
            ...
            """)
        httpretty.register_uri(httpretty.GET,
            APIURL + "/search/request?match=%28state%2F%40name%3D%27new%27+or+state%2F%40name%3D%27review%27%29+and+%28action%2Ftarget%2F%40project%3D%27openSUSE%3AFactory%27+or+submit%2Ftarget%2F%40project%3D%27openSUSE%3AFactory%27+or+action%2Fsource%2F%40project%3D%27openSUSE%3AFactory%27+or+submit%2Fsource%2F%40project%3D%27openSUSE%3AFactory%27%29+and+%28action%2Ftarget%2F%40package%3D%27timezone%27+or+submit%2Ftarget%2F%40package%3D%27timezone%27+or+action%2Fsource%2F%40package%3D%27timezone%27+or+submit%2Fsource%2F%40package%3D%27timezone%27%29+and+action%2F%40type%3D%27submit%27",
            responses = [
